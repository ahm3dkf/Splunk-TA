...
window.CategoryRootModel = function(){
    ...
    loadUrl = Splunk.util.make_url('custom','splunk_app_for_nix','unixsetup','splunk_app_for_nix','get_categories');
    saveUrl = Splunk.util.make_url('custom','splunk_app_for_nix','unixsetup','splunk_app_for_nix','save_categories');
    getHostsUrl = Splunk.util.make_url('custom','splunk_app_for_nix','unixsetup','splunk_app_for_nix','get_hosts');
